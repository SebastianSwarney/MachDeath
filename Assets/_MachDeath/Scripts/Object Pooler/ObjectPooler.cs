...
public class ObjectPooler : MonoBehaviour
{
    ...
    public List<GameObject> clientPooledObjects;
    ...
    public delegate GameObject SpawnDelegate(Vector3 spawnPosition, GameObject p_newObject);
    public delegate void UnSpawnDelegate(GameObject pooledObject);
    #endregion
    ...
    GameObject ClientGetNewObject(string poolName, GameObject requestedObject, Transform spawner, bool moveToTransform = true, bool rotateToTransform = true, bool isActive = true)
    {
        if (!objectPool.ContainsKey(poolName))
        {
            CreateNewPool(requestedObject);
    ...
    public GameObject NewObject(GameObject requestedObject, Vector3 spawnPosition, Quaternion angle, System.Guid assetId)
    {
        return GetNewObject(requestedObject.name, requestedObject, spawnPosition, angle, true);
    }

    public GameObject ClientSideObject(Vector3 spawnPos, GameObject m_newObject)
    {
        GameObject oof = null;
        return oof;
    }
