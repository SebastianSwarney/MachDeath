...
namespace Mirror.MachDeath {
    ...
    public class ObjectPooler : MonoBehaviour {
        ...
        [Header("Networking")]
        public List<GameObject> m_networkObjects;
        public Dictionary<string, ObjectPooler_Network> m_networkPoolers = new Dictionary<string, ObjectPooler_Network>();
        public Transform m_networkParent;

        [Header("General Pooler")]
        ...
        void Awake()
        {
            instance = this;
            InitialGrowth();
            CreateNetworkPoolers();
        }


        private void CreateNetworkPoolers()
        {
            foreach (GameObject networkedObject in m_networkObjects)
            {
                ...
                m_networkPoolers.Add(networkedObject.name, networkedPool);
            }
        }

        public ObjectPooler_Network GetPooler(string p_poolerName)
        {
            return m_networkPoolers[p_poolerName];
        }
